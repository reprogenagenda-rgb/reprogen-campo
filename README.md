...
## Correção aplicada
- `index-3.html` foi renomeado para `index.html`.
- Ícones foram colocados dentro da pasta `icons/` com nomes compatíveis com o manifesto.
- `manifest.json` ajustado para `start_url: ./index.html` e `scope: ./`.
- `service-worker.js` ajustado para funcionar em subpasta do GitHub Pages e evitar fallback HTML em CSS/fontes externas.
